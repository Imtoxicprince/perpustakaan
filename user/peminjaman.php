...
<body style="background-image: url(polos.png);">
    <?php
        include "navbar.php";
    ?>
    <br></br>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <ol>
                            <?php
                            $query_detail = mysqli_query($koneksi, "SELECT * FROM detail_peminjaman d JOIN buku b ON b.id_buku = d.id_buku WHERE id_peminjaman_buku = '".$data_peminjaman['id_peminjaman_buku']."'");
                        ...
                        if (mysqli_num_rows($query_cek_kembali) > 0) {
                            ...
                            echo "<td><label class='btn btn-dark'>Belum Kembali<br></label></td>";
                            echo "<td><a href='kembali.php?id=".$data_peminjaman['id_peminjaman_buku']."' class='btn btn-secondary'
